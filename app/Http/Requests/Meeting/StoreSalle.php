...
class StoreSalle extends FormRequest
{
    /**
    ...
    {
        return  [
            'name_ar.required' => 'لا يمكن ترك اسم القاعة فارغا',
            'description_ar.required' => 'لا يمكن ترك حقل التوصيف فارغا',
            'address_ar.required' => 'لا يمكن ترك حقل العنوان فارغا',
            'guest.required' => 'لا يمكن ترك حقل عدد الاشخاص فارغا',
            'type.required' => 'لا يمكن ترك نوع القاعة فارغا',
