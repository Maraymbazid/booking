...
@section('title','قاعات الاجتماعات' )
@section('css')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <h2 class="text-center display-4">إضافة قاعة
                </h2>
                <hr>
                <span id='sucess_msg'> </span>
                <form method="POST" enctype="multipart/form-data" id='addsalle'>
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="number" name="guest" id="guest" class="form-control form-control-lg"
                                                placeholder="" areia-describedby="helper" min="1" max="20">
                                        </div>
