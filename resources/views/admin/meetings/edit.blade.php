                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="description_ar" id="description_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $salle->description_ar}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="address_ar" id="address_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $salle->address_ar}}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                       <label> محافظة </label>
                                        ...
                                        @if($allgouvernements && $allgouvernements -> count() > 0)
                                            ...
                                            @if($allgouvernement->id ==  $salle->gouvernement)
                                        <option 
                               ...
                               <span class="invalid-feedback" role="alert" id='gouvernement_error'> </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="area" id="area" class="form-control form-control-lg"
                                                placeholder="" areia-describedby="helper" value="{{ $salle->area}}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="price" id="price" class="form-control form-control-lg"
                                                placeholder="" areia-describedby="helper" value="{{ $salle->price}}">
                                        </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="number" name="guest" id="guest" class="form-control form-control-lg"
                                                value="{{$salle->guest}}" areia-describedby="helper" min="1" max="20">
                                        </div>
                                        <span id='guest_error' class="invalid-feedback" role="alert"> </span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label> نوع  قاعة</label>
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="type" id="type" class="form-control form-control-lg"
                                                placeholder="" areia-describedby="helper" value="{{ $salle->type }}">
                                        </div>
                                        <span id='type_error' class="invalid-feedback" role="alert"> </span>
                                    </div>
                                </div>
