...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            @if ($allapartements->hasPages())
                    <nav>
                        <ul class="pagination">
                            {{-- Previous Page Link --}}
                            @if ($allapartements->onFirstPage())
                                <li class="page-item disabled">
                                    <a class="page-link" href="#" tabindex="-1">Previous</a>
                                </li>
                            @else
                                <li class="page-item ">
                                    <a class="page-link" href=" {{ $allapartements->previousPageUrl() }}"
                            ...
                            {{-- Next Page Link --}}
                            @if ($allapartements->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link"
                                        href="{{ $allapartements->nextPageUrl() }}">Next</a>
                                </li>
                            @else
