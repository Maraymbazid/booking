    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data" id="updateordersalle">
                    @csrf
                    <div class="row">
...
@section('js')
    ...
    <script>
        ...
        $('#updateordersalle').submit(function(e) {
            e.preventDefault();
            let formData = new FormData(this);
            $.ajax({
                type: 'POST',
                enctype: 'multipart/form-data',
                url: `{{route('updateordersalle')}}`,
                data: formData,
                contentType: false,
                processData: false,
                success: (response) => {
                    if (response) {
                        ...
                        window.location.href='{{ route('allorderssalles')}}';
                    }
                },
