    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data" id="updatediscountvilla" >
                    @csrf
                    <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="number_days" id="number_days"
                                                ...
                                                areia-describedby="helper" value="{{  $discountvilla->number_days}}">
                                            <input type="hidden" value="{{ $discountvilla->id}}" name="id">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="rate" id="rate"
                                                ...
                                                areia-describedby="helper"  value="{{  $discountvilla->rate}}">
                                        </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <label> اسم محافظة</label>
                                        <div class="input-group input-group-lg">
                                            <select _ngcontent-c9="" class="form-control hotels" id="gouvernement_id" name="gouvernement_id" data-dependent="hotels" disabled="true">
                                                <option value="{{ $discountvilla->villa->gouvernemente->id}}"> {{$discountvilla->villa->gouvernemente->name}} </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <label>اسم فلة</label>
                                    <div class="input-group input-group-lg">
                                        <select   class="form-control " style="width: 100%;" name="villa_id" disabled="true">
                                            <option value="{{$discountvilla->villa->id}}">{{$discountvilla->villa->name_ar}} </option>
                                        </select>
                                    </div>
            ...
            $.ajax({
                ...
                success: (response) => {
                    if (response) {
                        ...
                        window.location.href='{{ route('alldiscountvilla')}}';
                    }
                },
