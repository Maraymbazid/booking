    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data" id='updatevilla' action="">
                    @csrf
                    <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="name_ar" id="name_ar" value="{{$villa->name_ar}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="description_ar" id="description_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $villa->description_ar}}">
                                                <input type="hidden" value="{{ $villa->id}}" name="id">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="address_ar" id="address_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $villa->address_ar}}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="area" id="area" class="form-control form-control-lg"
                                                placeholder="" areia-describedby="helper" value="{{ $villa->area}}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="price" id="price" class="form-control form-control-lg"
                                                placeholder="" areia-describedby="helper" value="{{ $villa->price}}">
                                        </div>
            ...
            $.ajax({
                ...
                success: (response) => {
                    if (response) {
                        ...
                        window.location.href='{{ route('allvillas')}}';
