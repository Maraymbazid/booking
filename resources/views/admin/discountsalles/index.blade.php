                                ...
                                <table id="example1" class="table table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allDiscounts as $discount)
                                            <tr class="SalleRow{{$discount->id}}">
                                                <td> {{ $discount->meeting->name_ar  }}</td>
                                                <td> {{ $discount->hour_count }}</td>
                                                <td> % {{ $discount->discount }}</td>
                                                <td>
                                                     <button type="button" class="btn btn-warning">  <a
                                                            href="{{ route('editdiscountsalle', $discount->id) }}" class="">
                                                ...
                                                <td>
                                                <button class="btn btn-danger rounded"> <a href="" class="button-delete" salle_id="{{$discount->id}}">
...
<script>
        $(document).on('click', '.button-delete', function (e) {
            e.preventDefault();
            var  salle_id = $(this).attr('salle_id');
            $.ajax({
                type: 'post',
                url: "{{route('delete-discountsalle')}}",
                data: {
                    '_token': "{{csrf_token()}}",
                    'id' : salle_id
                },
