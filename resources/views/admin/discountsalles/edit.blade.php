    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data" id="updatediscountsalle" >
                    @csrf
                    <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="hour_count" id="hour_count"
                                                ...
                                                areia-describedby="helper" value="{{  $discountsalle->hour_count}}">
                                            <input type="hidden" value="{{ $discountsalle->id}}" name="id">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="discount" id="discount"
                                                ...
                                                areia-describedby="helper"  value="{{  $discountsalle->discount}}">
                                        </div>
                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <label>  اسم القاعة</label>
                                        <div class="input-group input-group-lg">
                                            <select _ngcontent-c9="" class="form-control hotels" id="salle_id" name="salle_id" data-dependent="hotels" disabled="true">
                                                <option value="{{$discountsalle->meeting->id}}"> {{ $discountsalle->meeting->name_ar}} </option>
                                            </select>
                                        </div>
...
@section('js')
    ...
    <script>
        ...
        $('#updatediscountsalle').submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: (response) => {
                    if (response) {
                        ...
                        window.location.href='{{ route('alldiscountsalle')}}';
                    }
                },
