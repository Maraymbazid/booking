                                ...
                                <table id="example1" class="table table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allDiscounts as $discount)
                                            <tr class="ApartementRow{{$discount->id}}">
                                                <td> {{ $discount->apartement->gouvernemente->name  }}</td>
                                                <td> {{ $discount->apartement->name_ar }}</td>
                                                <td> % {{ $discount->rate }}</td>
                                                <td>
                                                     <button type="button" class="btn btn-warning">  <a
                                                            href="{{ route('editdiscountapartement', $discount->id) }}" class="">
                                                ...
                                                <td>
                                                <button class="btn btn-danger rounded"> <a href="" class="button-delete" apartement_id="{{$discount->id}}">
...
<script>
        $(document).on('click', '.button-delete', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: "{{route('delete-discountapartement')}}",
                data: {
                    '_token': "{{csrf_token()}}",
                    'id' :apartement_id
                },
