    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data" id="updatediscountApartement" >
                    @csrf
                    <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="number_days" id="number_days"
                                                ...
                                                areia-describedby="helper" value="{{  $discountapartement->number_days}}">
                                            <input type="hidden" value="{{ $discountapartement->id}}" name="id">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="rate" id="rate"
                                                ...
                                                areia-describedby="helper"  value="{{  $discountapartement->rate}}">
                                        </div>
                                    ...
                                    <label> اسم محافظة</label>
                                        <div class="input-group input-group-lg">
                                            <select _ngcontent-c9="" class="form-control hotels" id="hotel_id" name="hotel_id" data-dependent="hotels" disabled="true">
                                                <option value="{{ $discountapartement->apartement->gouvernemente->id}}"> {{$discountapartement->apartement->gouvernemente->name}} </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="input-group input-group-lg">
                                        <select   class="form-control " style="width: 100%;" name="room_id" disabled="true">
                                            <option value="{{$discountapartement->apartement->id}}">{{$discountapartement->apartement->name_ar}} </option>
                                        </select>
                                    </div>
...
@section('js')
    ...
    <script>
        ...
        $('#updatediscountApartement').submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                url: `{{ route('updatediscountApartement') }}`,
                data: formData,
                contentType: false,
                processData: false,
                success: (response) => {
                    if (response) {
                        ...
                        window.location.href='{{ route('alldiscountapartement')}}';
                    }
                },
