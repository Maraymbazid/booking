    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data" id="adddiscountapartement">
                    @csrf
                    <div class="row">
                        <div class="col-md-10 offset-md-1">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                    <div class="input-group input-group-lg">
                                        <select id="gouvernements"  class="form-control " style="width: 100%;" name="apartement_id" >
                                            <option>   اختر شقة </option>
                                        </select>
                                    </div>
                                    <span class="invalid-feedback" role="alert" id='apartement_id_error'> </span>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
 ...
 <script>
        ...
        $('#adddiscountapartement').submit(function(e) {
            ...
            $.ajax({
                ...
                url: `{{ route('storediscountapartement') }}`,
                data: formData,
                contentType: false,
                processData: false,
                success: (response) => {
