...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            @if ($allgouvernements->hasPages())
                    <nav>
                        <ul class="pagination">
                            {{-- Previous Page Link --}}
                            @if ($allgouvernements->onFirstPage())
                                <li class="page-item disabled">
                                    <a class="page-link" href="#" tabindex="-1">Previous</a>
                                </li>
                            @else
                                <li class="page-item ">
                                    <a class="page-link" href=" {{ $allgouvernements->previousPageUrl() }}"
                            ...
                            @if ($allgouvernements->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link"
                                        href="{{ $allgouvernements->nextPageUrl() }}">Next</a>
                                </li>
                            @else
...
<script>
        $(document).on('click', '.button-delete', function (e) {
            ...
            $.ajax({
                ...
                success: (response) => {
                    if (response) {
                    $('.gouvernementRow'+response.id).remove();
                    Swal.fire({
                            position: 'top-center',
                            icon: 'success',
                            title: response.msg,
