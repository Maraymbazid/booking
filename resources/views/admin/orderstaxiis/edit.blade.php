    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form method="POST" enctype="multipart/form-data"  id="updateordertaxi">
                    @csrf
                    <div class="row">
...
@section('js')
    ...
    <script>
        ...
        $('#updateordertaxi').submit(function(e) {
            e.preventDefault();
            let formData = new FormData(this);
            $.ajax({
                type: 'POST',
                enctype: 'multipart/form-data',
                url: `{{route('updateordertaxi')}}`,
                data: formData,
                contentType: false,
                processData: false,
                success: (response) => {
                    if (response) {
                        ...
                        window.location.href='{{ route('allorderstaxis')}}';
                    }
                },
