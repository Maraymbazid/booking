    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid" id='createhotel'>
                <h6 class="text-center display-4"> اضافة برمو </h6>

                <form method="POST" enctype="multipart/form-data" id='addpromo' >
                    @csrf
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="date"  id='begindate' name='begindate'  class="form-control form-control-lg"  >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="number"  id='personnes' name='personnes'  class="form-control form-control-lg" min="1" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
