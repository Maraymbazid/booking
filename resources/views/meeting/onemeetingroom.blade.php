                ...
                <div id="car1" class="carousel " data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item  @if( $loop->first == 1 ) active @endif "  >
                            <div class="sosy"  style="background-image: url({{ url("/") .  "/assets/admin/img/salles/covers/" . $i->image}});" >
                            </div>
                        </div>
                        @endforeach>
                    </div>
    ...
    <div class="row mt-5" >
        <div class="col-12" >
            <p style="text-align:center;cursor: pointer; color:red; font-size:18px ">
                 <a style="margin-top:10px" type="button"  value='{{$salle->id}}'  data-toggle="modal" data-target="#carImages">
                  ...
                  <div class="modal fade" id="carImages" tabindex="-1"  aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                             <div class="modal-content " style="text-align:center">
                                ...
                                <div id="slideroom{{$salle->id}}" class="carousel " data-ride="carousel">
                                <ol class="carousel-indicators">
                                    @foreach ($salle->images as $i)
                                    <li   data-target="#slideroom{{$salle->id}}"   class='adaw @if( $loop->first == 1 ) active @endif'  data-slide-to="{{ $loop->index }}" > </li>
                                    @endforeach
